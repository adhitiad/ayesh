...
description: Firecrawl API key for hosted Firecrawl requests when the workflow runs through the CLI or API. (dari C:\Users\humas\.agents\skills\firecrawl-workflows\SKILL.md)
---
