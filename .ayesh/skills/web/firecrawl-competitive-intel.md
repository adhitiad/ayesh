...
description: Firecrawl API key for hosted Firecrawl requests. (dari C:\Users\humas\.agents\skills\firecrawl-competitive-intel\SKILL.md)
---

# Skill: firecrawl-competitive-intel
