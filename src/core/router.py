...
def _apply_session_affinity(
    ...
    try:
        from src.core.sessions import update_session
...
def _build_augmented_prompt(
    ...
    try:
        from src.core.monologue import get_latest_monologue, get_role_for_agent
...
def _run_full_agent(
    ...
    from src.core.tools import log_tool_failure, learn_from_tool_failure
    from src.core.sessions import update_session, generate_session_name_context
...
def route_request_inner(user_input: str, session_id: str, _depth: int = 0) -> dict:
    ...
    from src.core.adaptive_router import classify_agent
    ...
    from src.core.auth import get_current_user_id, get_current_user_role
    from src.core.approval import set_current_session, set_current_owner_user_id
    from src.core.rate_limiter import TokenBucket
    from src.core.tools import filter_tools_by_keywords, get_quarantined_tools
    from src.core.intent import detect_actionable_intent, auto_learn_keyword
    from src.core.skills import extract_skill_invocation, split_fanout_segments
    from src.core.commands import handle_bantuan, handle_ringkas
    from src.core.fanout import route_fanout
    from src.core.llm_shortcut import llm_shortcut
    from src.core.learning import process_pending_learnings
    ...
    sess_info = get_or_create_session(session_id, user_id, owner_user_id)
