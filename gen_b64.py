import base64
content = b'''from fastapi import APIRouter
...
from src.core.auth import require_auth, require_owner, require_admin, require_owner_or_admin, get_current_user_id
from src.core.error_handling import generate_request_id, safe_error_response, sanitize_exception, log_internal_error
...
async def chat_stream(req: ChatRequest, request: Request):
    ...
    async def _gen():
        ...
        task = asyncio.create_task(
            asyncio.to_thread(route_request, req.message, session_id)
        )
        while True:
...
def chat(req: ChatRequest, request: Request):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=safe_resp)
'''
with open(r'E:\code\fr\chat_b64.txt', 'wb') as f:
