---
name: migrate-websets-to-agent
description: Migrate Websets to the Agent API (dari C:\Users\humas\.agents\skills\build-with-exa\references\migrate-websets-to-agent.md)
---

# Skill: migrate-websets-to-agent
