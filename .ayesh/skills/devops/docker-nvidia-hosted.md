---
name: docker-nvidia-hosted
description: Docker Deployment (NVIDIA-Hosted NIMs) (dari C:\Users\humas\.agents\skills\rag-blueprint\references\deploy\docker-nvidia-hosted.md)
---

# Skill: docker-nvidia-hosted
