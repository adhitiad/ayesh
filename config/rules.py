AGENT_RULES = {
    "coder_agent": {
        ...
        "skills": ["tulis_kode", "baca_file", "learn_keyword", "get_current_time", "minta_review", "baca_url", "jalankan_python", "panggil_mcp", "lihat_preferensi", "simpan_proyek", "catat_proyek", "lihat_proyek"],
        "tool_policy": {
...
SUBAGENTS = {
    "coder_agent": {
        ...
        "tools": ["tulis_kode", "baca_file", "learn_keyword", "get_current_time", "minta_review", "baca_url", "jalankan_python", "panggil_mcp", "lihat_preferensi", "simpan_proyek", "catat_proyek", "lihat_proyek"],
    },
    "admin_agent": {
